<template>
    <main>
        <div class="container mx-auto md:h-full py-12 px-6">
            <div class="flex flex-col md:flex-row h-full bg-cBlack text-white rounded-lg px-12 py-12">
                ...
                <div class="w-full md:w-1/2 flex flex-col justify-between">
                    ...
                    <div class="flex space-x-6">
                        <Button v-if="project.demo" type="tertiary" class="mt-6 w-full md:w-fit">
                            {{ $t('utils.projects.demo') }}
                        </Button>
                        <Button v-if="project.source" type="tertiary" class="mt-6 w-full md:w-fit" :href="project.link" target="_blank">
